...
use Arcanum\Shodo\JsonExceptionRenderer;
...
#[CoversClass(JsonExceptionRenderer::class)]
...
final class JsonExceptionRendererTest extends TestCase
{
    ...
    {
        // Arrange
        $renderer = new JsonExceptionRenderer(new JsonRenderer());
    ...
    {
        // Arrange
        $renderer = new JsonExceptionRenderer(new JsonRenderer(), debug: false);
    ...
    {
        // Arrange
        $renderer = new JsonExceptionRenderer(new JsonRenderer(), debug: true);
